...
\begin{figure}[htp] 
	...
	\subfloat[Regression de Fruity.before.shaking, équation 1]{%
		\includegraphics[scale=1.2]{images/Pred_Eq_FBS.png}%
	}%
	\hfill%
	\subfloat[Regression de Spice.before.shaking, équation 1]{%
		\includegraphics[scale=1.2]{images/Pred_Eq_SBS.png}%
	}%
\end{figure}
...
\begin{figure}[htp] 
	...
	\subfloat[Regression de Fruity, équation 1]{%
		\includegraphics[scale=1.2]{images/Pred_Eq_F.png}%
	}%
	\hfill%
	\subfloat[Regression de Spice, équation 1]{%
		\includegraphics[scale=1.2]{images/Pred_Eq_S.png}%
	}%
\end{figure}
...
\begin{figure}[htp] 
	...
	\subfloat[Regression de Odor.Intensity.before.shaking, équation 2]{%
		\includegraphics[scale=1.2]{images/Pred_Eq_OIB.png}%
	}%
	\hfill%
	\subfloat[Regression de Odor.Intensity, équation 2]{%
		\includegraphics[scale=1.2]{images/Pred_Eq_OI.png}%
	}%
	\hfill%
	\subfloat[Regression de Quality.of.odour, équation 2]{%
		\includegraphics[scale=1.2]{images/Pred_Eq_Q.png}%
	}%
...
\begin{figure}[htp] 
	\centering
	\subfloat[Représentation direct et dual du thème \textit{Goût} plan 1-2]{%
		\includegraphics[scale=0.8]{images/Plot.IndVar_B3_1.2.png}%
	}%
	\hfill%
	\subfloat[Représentation direct et dual du thème \textit{Goût} plan 1-3]{%
		\includegraphics[scale=0.8]{images/Plot.IndVar_B3_1.3.png}%
	}%
\end{figure}
\begin{figure}[htp] 
	\centering
...
\begin{figure}[htp] 
	\centering
	\subfloat[Regression de Odor.Intensity.before.shaking]{%
		\includegraphics[scale=1.2]{images/Pred_Cross_OIB.png}%
	}%
	\hfill%
	\subfloat[Regression de Odor.Intensity]{%
		\includegraphics[scale=1.2]{images/Pred_Cross_OI.png}%
	}%
	\hfill%
	\subfloat[Regression de Quality.of.odour]{%
		\includegraphics[scale=1.2]{images/Pred_Cross_Q.png}%
	}%
